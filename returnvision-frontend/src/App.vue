<template>
  <div class="app-layout">
    ...
    <main class="app-content">
      <HomePanel v-if="activeTab === 'home'" @uploaded="handleUploaded" />
      <ProcessPanel v-if="activeTab === 'process'" :result="uploadResult"
        @confirmed="handleConfirmed" @reset="handleReset" />
...
.mobile-tab {
  ...
  padding: 8px 0; cursor: pointer; color: var(--color-text-muted);
...
.app-footer {
  ...
  font-size: 13px; border-top: 1px solid var(--color-border); margin-top: 40px;
}
