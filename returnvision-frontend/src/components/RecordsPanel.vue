<template>
  <div class="records-panel">
    ...
    <div class="filter-bar">
      <el-select v-model="filterStatus" placeholder="状态筛选" clearable @change="loadRecords" style="width: 140px">
    ...
    <div v-if="isMobile" v-loading="loading" class="card-list">
      <div v-for="r in records" :key="r.id" class="record-card">
        ...
        <div v-if="r.status === 'pending'" class="card-action">
          <el-button type="primary" size="small" @click="confirmRecord(r)">确认写入飞书</el-button>
        </div>
      </div>
...
.card-id { font-weight: 700; color: var(--color-text); }
