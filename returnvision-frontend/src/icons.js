...
export const UserFilled = icon(['M12 12 m-4 0 a4 4 0 1 0 8 0 a4 4 0 1 0 -8 0', 'M5.5 21 a8 8 0 0 1 13 0']);
export const ChevronDown = icon(['m6 9 6 6 6-6']);
export const UserCircle = icon(['M12 12 m-10 0 a10 10 0 1 0 20 0 a10 10 0 1 0 -20 0', 'M12 12 m-4 0 a4 4 0 1 0 8 0 a4 4 0 1 0 -8 0', 'M5.5 20 a8 8 0 0 1 13 0']);
export const LogoutIcon = icon(['M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4', 'm16 17 5-5-5-5', 'M21 12H9']);
